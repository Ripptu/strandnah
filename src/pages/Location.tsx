      ...
      <div className="max-w-[1280px] mx-auto px-6 lg:px-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
          ...
          <div className="rounded-3xl overflow-hidden h-[450px] shadow-xl border border-border-light relative">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d152174.453303799!2d13.916962450000002!3d53.9458213!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47ab09c4d93e7845%3A0x422730225d3df10!2sUsedom!5e0!3m2!1sde!2sde!4v1714995000000!5m2!1sde!2sde" 
              width="100%" 
              height="100%" 
              style={{ border: 0 }} 
